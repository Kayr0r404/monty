#include "monty.h"
/**
 * _stack - changes the flack to 0
 * so that we can add at the beginning of the list
 * @head: input stack
 * @line: monty line
*/
...
/**
 * _addnode - Write a function that adds a new node
 * at the beginning of a  stack_t list.
 * @head: input doubly monty
 * @line_number: line number on monty file
*/
void _addnode(stack_t **head, unsigned int line_number)
{
	stack_t *new_node;
